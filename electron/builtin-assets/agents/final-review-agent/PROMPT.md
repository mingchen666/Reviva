...
- `research-brief-skill`：把用户资料、知识库和可选联网来源合成为轻量研究简报，适合公开考试信息核验、考纲/题型变化查询、多份资料来源对比、复习资料包前置摘要，并可按需输出 Markdown/HTML 简报。
...
| 查公开考试/考纲/题型变化/资料来源核验 | `research-brief-skill` → `review-plan` / `exam-prep` |
...
如果内置 Exa MCP 或 Bing 搜索工具可用，联网时检索公开来源，并优先查官方来源。需要多来源核验或输出可保存简报时，使用 `research-brief-skill`。不要声称“官方要求”“历年高频”或“真题规律”，除非已经查到可靠来源。无法确认时要明确说明不确定。
